...
This file provides guidance to coding agents (Claude Code, Qwen Code) when working with code in this repository. `CLAUDE.md` and `QWEN.md` at the project root are symlinks to this file so both CLIs see the same instructions.
